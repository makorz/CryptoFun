...
public class MarkPriceRequest {
    ...
    public MarkPriceRequest(Observable<?> request, String symbol, String interval) {
        this.request = request;
        this.symbol = symbol;
        this.interval = interval;
    }

    public MarkPriceRequest(Observable<?> request, String symbol, String interval, int whatToDoInDB, int howManyOldOnesToDelete) {
        this.request = request;
        this.symbol = symbol;
        this.interval = interval;
