...
public class ResultsListAdapter extends RecyclerView.Adapter<com.example.cryptofun.ui.results.ResultsListAdapter.ViewHolder> implements CallbackButton {
    ...
    public com.example.cryptofun.ui.results.ResultsListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new com.example.cryptofun.ui.results.ResultsListAdapter.ViewHolder(binding);
    }
    ...
    public void onBindViewHolder(@NonNull com.example.cryptofun.ui.results.ResultsListAdapter.ViewHolder holder, int position) {
