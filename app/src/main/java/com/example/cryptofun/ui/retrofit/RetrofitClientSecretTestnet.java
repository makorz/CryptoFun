...
public class RetrofitClientSecretTestnet {
    ...
    //0 -> balance 1 -> leverage, 2 marginType, 3 - marketorder, 4,5 - stoplimitmarketorder/takeprofitmarketorder, 5 - cancelorder 6 - order limit
    ...
    private long recvWindow = 10000;

    // Constructor nr 1 -> Balance
...
//        Log.e(TAG, "API: " + apikey + ", SECRET:" + secret + ", WINDOW: " + recvWindow);
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(ApiEndpointInterface.TESTNET)
...
//        Log.e(TAG, "API: " + apikey + ", SECRET:" + secret + ", WINDOW: " + recvWindow);
        ...
        if (secret.equals("null")) {
            ...
            client = new OkHttpClient.Builder()
                    ...
                    .readTimeout(30, TimeUnit.SECONDS)
                    .writeTimeout(30, TimeUnit.SECONDS)
                    .addInterceptor(new SignatureInterceptor(apikey, secret, typeOfRetrofitClient, symbol, leverage, timestamp))
                    .build();
        }
...
//        Log.e(TAG, "API: " + apikey + ", SECRET:" + secret + ", WINDOW: " + recvWindow);
        ...
        if (secret.equals("null")) {
            ...
            client = new OkHttpClient.Builder()
                    ...
                    .readTimeout(30, TimeUnit.SECONDS)
                    .writeTimeout(30, TimeUnit.SECONDS)
                    .addInterceptor(new SignatureInterceptor(apikey, secret, typeOfRetrofitClient, symbol, marginType, timestamp))
                    .build();
        }
    ...
    private RetrofitClientSecretTestnet(Context context, String symbol, String side, String type, String newOrderRespType, String quantity, long timestamp) {
        ...
        if (secret.equals("null")) {
            ...
            client = new OkHttpClient.Builder()
                    ...
                    .readTimeout(30, TimeUnit.SECONDS)
                    .writeTimeout(30, TimeUnit.SECONDS)
                    .addInterceptor(new SignatureInterceptor(apikey,secret,3, symbol, side, type, newOrderRespType, quantity, timestamp))
                    .build();
        }
    ...
    private RetrofitClientSecretTestnet(Context context, String symbol, String side, String type, String newOrderRespType, String stopLimit, String closePosition,long timestamp) {
        ...
        if (secret.equals("null")) {
            ...
            client = new OkHttpClient.Builder()
                    ...
                    .readTimeout(30, TimeUnit.SECONDS)
                    .writeTimeout(30, TimeUnit.SECONDS)
                    .addInterceptor(new SignatureInterceptor(apikey,secret, 4, symbol, side, type, newOrderRespType, stopLimit, closePosition, timestamp))
                    .build();
        }
    ...
    private RetrofitClientSecretTestnet(Context context, String symbol, long orderId, long timestamp) {
        ...
        if (secret.equals("null")) {
            ...
            client = new OkHttpClient.Builder()
                    ...
                    .readTimeout(30, TimeUnit.SECONDS)
                    .writeTimeout(30, TimeUnit.SECONDS)
                    .addInterceptor(new SignatureInterceptor(apikey, secret,5, symbol, orderId, timestamp))
                    .build();
        }
    ...
    private RetrofitClientSecretTestnet(Context context, String symbol, String side, String type, String newOrderRespType, String timeInForce, String quantity, String price, long timestamp) {
        ...
        if (secret.equals("null")) {
            ...
            client = new OkHttpClient.Builder()
                    ...
                    .readTimeout(30, TimeUnit.SECONDS)
                    .writeTimeout(30, TimeUnit.SECONDS)
                    .addInterceptor(new SignatureInterceptor(apikey,secret,6,symbol, side, type, newOrderRespType, timeInForce, quantity, price, timestamp))
                    .build();
        }
    ...
    private RetrofitClientSecretTestnet(Context context, String symbol, long timestamp) {
        ...
        if (secret.equals("null")) {
            ...
            client = new OkHttpClient.Builder()
                    ...
                    .readTimeout(30, TimeUnit.SECONDS)
                    .writeTimeout(30, TimeUnit.SECONDS)
                    .addInterceptor(new SignatureInterceptor(apikey,secret,7,symbol, timestamp))
                    .build();
        }
    ...
    private RetrofitClientSecretTestnet(Context context, long timestamp) {
        ...
        if (secret.equals("null")) {
            ...
            client = new OkHttpClient.Builder()
                    ...
                    .readTimeout(30, TimeUnit.SECONDS)
                    .writeTimeout(30, TimeUnit.SECONDS)
                    .addInterceptor(new SignatureInterceptor(apikey,secret,8, timestamp, 1))
                    .build();
        }
